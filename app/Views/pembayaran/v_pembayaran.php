  ...
  <div class="content-wrapper"  style="background-image: url('../gambar/background-resto1.jpeg');">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1  style="color:#fff">Daftar Pembayaran</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item p-1"><a href="#"  style="color:#fff">Pembayaran</a></li>
              <li class="breadcrumb-item active p-1"  style="color:#fff">Daftar Pembayaran</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" style="background-color:#CCA97C">
                <style>
                      .muda-background {
