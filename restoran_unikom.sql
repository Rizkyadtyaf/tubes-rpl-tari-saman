...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2024 at 07:57 PM
...
CREATE TABLE `meja` (
  ...
  `status_meja` enum('Kosong','Terisi') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `pegawai` (
  ...
  `nama` varchar(50) DEFAULT NULL,
  `jabatan` enum('Kasir','Koki','Pelayan') DEFAULT NULL,
...
('KOK001', 'eril', 'Koki', 'Laki-laki', 'koki', '123'),
('KSR001', 'nina', 'Kasir', 'Laki-laki', 'kasir', '123'),
('PYN001', 'rizky', 'Pelayan', 'Laki-laki', 'pelayan', '123');
...
CREATE TABLE `pembayaran` (
  ...
  `nrp_kasir` varchar(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, NULL, 60000.00, 6000.00, 66000.00, 0.00, 0.00, 'Belum Bayar', 'KSR001'),
(2, '2024-07-22', 194000.00, 19400.00, 213400.00, 213400.00, 0.00, 'Sudah Bayar', 'KSR001'),
(3, NULL, 15000.00, 1500.00, 16500.00, 0.00, 0.00, 'Belum Bayar', 'PYN001'),
(4, '2024-07-22', 45000.00, 4500.00, 49500.00, 50000.00, 500.00, 'Sudah Bayar', 'KSR001');
...
CREATE TABLE `pemesanan` (
  ...
  `status_pemesanan` enum('Belum Selesai','Selesai') DEFAULT 'Belum Selesai',
...
(4, 2, '2024-07-22', 'repa', 'Selesai', 'KOK001');
